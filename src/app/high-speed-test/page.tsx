 ...
 * typingmania-ref風純粋実装 vs 現在の実装
 */
export default function HighSpeedTestPage() {
  const [currentMode, setCurrentMode] = useState<'pure' | 'current'>('pure');
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        marginBottom: '20px',
        padding: '15px',
        backgroundColor: currentMode === 'pure' ? '#e8f5e8' : '#fff3e0',
        borderRadius: '8px',
        border: `2px solid ${currentMode === 'pure' ? '#4CAF50' : '#FF9800'}`
      }}>
